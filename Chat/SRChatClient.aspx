    ...
    <script id="new-online-contacts" type="text/x-jquery-tmpl">
        ...
        {{each messageRecipients}}
            <li id="chatLink${messageRecipientId}">
                <a href="javascript:;" onclick="javascript:SRChat.initiateChat('${messageRecipientId}','${messageRecipientName}');">
                    Usuário:${messageRecipientName}</a>
            </li>
        {{/each}}
        </ul>
        </div>
...
<body>
    ...
    <div>
        ...
        <div id="userNameLabel">
            <a runat="server" id="nomeusuario"></a>
        </div>
        <br />
        <br />
        <div id="chatRooms">
 ...
 <script type="text/javascript"> 
     ...
     SRChat = new function () {
         ...
         var senderName = 'User ' + document.getElementById("nomeusuario").innerText;
